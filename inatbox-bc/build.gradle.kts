...
cloudstream {
    authors     = listOf("Dr.Octagon")
    language    = "tr"
    description = "Güncel sunucu protokolü ve saat eşitleme desteği."
...
tasks.named<com.lagradost.cloudstream3.gradle.tasks.GenerateManifestTask>("generateManifest") {
    pluginName.set("InatBox")
}
